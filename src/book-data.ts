...
export const BOOKS_BY_CODE: Record<string, BookInfo> = ALL_BOOKS.reduce(
    (acc, book) => {
        acc[book.code] = book;
        return acc;
    },
...
export const BOOKS_BY_NUMBER: Record<number, BookInfo> = ALL_BOOKS.reduce(
    (acc, book) => {
...
export const ALIAS_TO_BOOK: Record<string, BookInfo> = ALL_BOOKS.reduce(
    (acc, book) => {
